...
public class PedidoCompraModel {
    ...
    public List<PedidoEstoqueProdutoModel> getProdutos() { return produtos; }
    public void setProdutos(List<PedidoEstoqueProdutoModel> produtos) { this.produtos = produtos; }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof PedidoCompraModel)) return false;
